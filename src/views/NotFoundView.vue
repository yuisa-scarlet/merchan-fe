      ...
      <div class="mx-auto mt-16 flow-root max-w-lg sm:mt-20">
        ...
        <ul role="list" class="-mt-6 divide-y divide-gray-900/5 border-b border-gray-900/5">
          <li v-for="(link, linkIdx) in links" :key="linkIdx" class="relative flex gap-x-6 py-6">
            ...
            >
              <component :is="link.icon" class="size-6 text-indigo-600" aria-hidden="true" />
            </div>
            <div class="flex-auto">
              ...
              <p class="mt-2 text-sm/6 text-gray-600">{{ link.description }}</p>
            </div>
        ...
        <div class="mt-10 flex justify-center">
          <RouterLink to="/" class="text-sm/6 font-semibold text-indigo-600"
